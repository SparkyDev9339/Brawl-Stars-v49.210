...
class LogicMasteryRoadRewardCommand(LogicCommand):
    ...
    def execute(self, calling_instance, fields, cryptoInit):
        ...
        if fields["BrawleIndex"][1] in [0, 1, 2, 3, 4, 6, 7, 8, 9, 10, 11, 13, 14, 15, 16, 18, 19, 20, 22, 24, 25, 26, 27, 29, 30, 34, 36, 43, 45, 47, 48, 50, 61]:
        	if fields["MasteryIndex"] == 2: # 750 coins
        		item = {'Amount': 750, 'DataRef': [16, fields["BrawleIndex"][1]], 'RewardID': 7}
        		box['Items'].append(item)
        		box['Type'] = 100
        		player_data["delivery_items"]['Boxes'].append(box)
        	elif fields["MasteryIndex"] == 3: # 100 power points
        		item = {'Amount': 100, 'DataRef': [16, fields["BrawleIndex"][1]], 'RewardID': 5}
        		box['Items'].append(item)
        		box['Type'] = 100
        		player_data["delivery_items"]['Boxes'].append(box)
